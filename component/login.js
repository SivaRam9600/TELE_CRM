...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <ScrollView style={styles.container}>
        ...
        <Image style={styles.logo} source={require('./assets/telecrm_image1.png')} resizeMode='contain' />
      ...
      />
       {/* <TouchableOpacity  onPress={()=>navigation.navigate("Forgot")}>
                <Text style={{color:"#7b68ee",}}>Forgot?</Text>
              </TouchableOpacity> */}
       </View>
     
      {/* <TouchableOpacity style={styles.loginButton}onPress={()=>navigation.navigate("About")}> */}
      {/* <TouchableOpacity style={styles.loginButton}onPress={()=>navigation.navigate("AddProfile")}> */}
      <TouchableOpacity style={styles.loginButton}onPress={()=>navigation.navigate("Home1")}> 
